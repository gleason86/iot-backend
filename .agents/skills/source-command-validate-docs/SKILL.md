---
name: "source-command-validate-docs"
description: "Migrated source command `validate-docs`"
---

# source-command-validate-docs

Use this skill when the user asks to run the migrated source command `validate-docs`.
